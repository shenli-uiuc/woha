 ...
 */
class PlanWorkflowScheduler extends TaskScheduler {
  ...
  protected PlanWorkflowListener planWorkflowListener;
  protected EagerTaskInitializationListener eagerTaskInitializationListener;
  private float padFraction;
  
  public PlanWorkflowScheduler() {
    this.planWorkflowListener = new PlanWorkflowListener();
  }
  
  @Override
  public synchronized void start() throws IOException {
    super.start();
    taskTrackerManager.addJobInProgressListener(planWorkflowListener);
    taskTrackerManager.addWorkflowInProgressListener(planWorkflowListener);
  ...
  public synchronized void terminate() throws IOException {
    if (planWorkflowListener != null) {
      taskTrackerManager.removeJobInProgressListener(
          planWorkflowListener);
