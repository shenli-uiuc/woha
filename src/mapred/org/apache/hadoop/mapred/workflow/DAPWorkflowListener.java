...
/**
 * A {@link DAPWorkflowListener} that maintains the jobs and workflows
 * being managed in a queue in the decreasing order of their progresses:
 * schedWork - requirement.
 */
class DAPWorkflowListener extends JobInProgressListener 
  ...
  new Comparator<Object>() {
    ...
    public int compare(Object o1, Object o2) {
      ...
      if (o1 instanceof WorkflowInProgress &&
        ...
        long d1 = wip1.getConf().getDeadline();
        long d2 = wip2.getConf().getDeadline();
        long ttd1 = d1 - curTime;
        long ttd2 = d2 - curTime;
        long req1 = 
        ...
        // if both fall behind plan, use edf
        if (res1 < 0 && res2 < 0) {
          if (d1 < d2) {
            return -1;
          } else if (d1 > d2) {
