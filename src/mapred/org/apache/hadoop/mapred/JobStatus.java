...
public class JobStatus implements Writable, Cloneable {
  ...
  // Shen Li: indicates which workflow this job belongs to
   ...
   */
  public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
                   float cleanupProgress, int runState, WorkflowID wfid) {
    this(jobid, mapProgress, reduceProgress, cleanupProgress, runState,
         JobPriority.NORMAL, wfid);
  }
   ...
   */
  public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
                   int runState, WorkflowID wfid) {
    this(jobid, mapProgress, reduceProgress, 0.0f, 
         runState, JobPriority.NORMAL, wfid);
  }
   ...
   */
   public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
     ...
     this(jobid, 0.0f, mapProgress, reduceProgress, 
          cleanupProgress, runState, jp, null);
   }
  ...
  public JobStatus(JobID jobid, float mapProgress, float reduceProgress,
                   float cleanupProgress, int runState, 
                   JobPriority jp, WorkflowID wfid) {
    this(jobid, 0.0f, mapProgress, reduceProgress, cleanupProgress,
         runState, jp, wfid); 
  }
   ...
   */
   public JobStatus(JobID jobid, float setupProgress, float mapProgress,
     ...
     this(jobid, setupProgress, mapProgress, reduceProgress,
          cleanupProgress, runState, jp, null);
   }
   ...
   public JobStatus(JobID jobid, float setupProgress, float mapProgress,
                    float reduceProgress, float cleanupProgress,
                    int runState, JobPriority jp, WorkflowID wfid) {
     this.jobid = jobid;
     this.wfid = wfid;
  ...
  /**
   * Shen Li: the id of the workflow the job belongs to
   */
  ...
  /**
   * Shen Li: set Workflow ID, called in JobInProgress constructor
   */
