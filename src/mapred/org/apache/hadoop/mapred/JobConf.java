...
public class JobConf extends Configuration {
  ...
  public static final long INF_DEADLINE = 9999999999999L;
  ...
  /**
   * Shen Li: job ID format used to do precheck before inserting into job
   * properties.
   */ 
  public static final String jobIDFormat = "job_[0-9]+_[0-9]+";
  ...
  /**
   * Shen Li: get the workflow ID which this job belongs to.
   *
   * @return The workflow ID as an object. null means this job
   *         does not belong to any workflow
   */
  public WorkflowID getWorkflowID() {
    try {
      return WorkflowID.fromString(get("mapred.job.wfid", null));
  ...
  /**
   * Shen Li: set workflow ID
   */
  public void setWorkflowID(WorkflowID wfid) {
    if (null != wfid) {
      set("mapred.job.wfid", wfid.toString());
    }
  }

  /**
   * Shen Li: deadline in unix time
   */
  ...
  /**
   * Shen Li: get job deadline
   */
  public long getDeadline() {
    return getLong("mapred.job.deadline", INF_DEADLINE);
  }

  /**
   * Shen Li: Concatenate job IDs into a string, then set dependencies of the job.
   *
   * @param deps an array of strings containing the job IDs.
   */
  public void setJobDepends(String depends[]) {
    setStrings("mapred.job.depends", depends);
  } 

  /**
   * Shen Li: get the job's dependency as an array of job IDs.
   *
   * @return deps an array of dependence job IDs.
   */ 
  public String [] getJobDepends() {
    return getStrings("mapred.job.depends", null);
  }

  /**
   * Shen Li: set the job's predecessors
   */
  public void setJobDependants(String dependants[]) {
    setStrings("mapred.job.dependants", dependants);
  }

  /**
   * Shen Li: get the job's predecessors as an array of job IDs.
   */
  public String [] getJobDependants(String dependants[]) {
    return getStrings("mapred.job.dependants", null);
  }
