...
public class ClusterMetrics implements Writable {
  ...
  //Shen Li
  private int totalWfSubmissions;
  ...
  public ClusterMetrics(int runningMaps, int runningReduces,
    ...
    //Shen Li
    this.totalWfSubmissions = totalWfSubmissions;
   ...
   * Shen Li
   */
  public int getTotalWfSubmissions() {
    return totalWfSubmissions;
  }
  ...
  public void write(DataOutput out) throws IOException {
    ...
    //Shen Li
    out.writeInt(totalWfSubmissions);
